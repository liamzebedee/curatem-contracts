...
const marketMakerFactoryAbi = [
  ...
  'function implementationMaster() public view returns (address)',
...
class MarketMakerFactoryService {
  ...
  constructor(address: string, provider: any, signer: any, signerAddress: Maybe<string>) {
    // TODO: assert provider is Signer
    this.contract = new ethers.Contract(address, marketMakerFactoryAbi, signer)
  ...
  predictMarketMakerAddress = async (
    ...
    const cloneConstructorEncodedCall = cloneFactoryInterface.encodeFunctionData(cloneFactoryInterface.getFunction('cloneConstructor'), [
...
//   }
  ...
  static encodeCreateMarketMaker = (
    ...
    return create2FixedProductMarketMakerInterface.encodeFunctionData(create2FixedProductMarketMakerInterface.getFunction('create2FixedProductMarketMaker'), [
