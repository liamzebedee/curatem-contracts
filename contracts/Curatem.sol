...
contract PredictionMarket {
    uint numOutcomes;
    constructor(uint _numOutcomes) {
        numOutcomes = _numOutcomes;
    }

    function invest(uint outcomeSlot, uint amount) {
        // collateralToken.transferFrom(msg.sender, this, amount)
        // mint(amount)
        // 

        // create a balancer pool for the three outcomes
        // YES,NO,REP
    }

    function createMarket() {
        // transfer minimum rep amount
        // mint YES, mint NO.
        // create uniswap pools on either side.
    }
}
